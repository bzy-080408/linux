...
static const struct regulator_bulk_data boe_nt35596s_5p5boe_vdo_supplies[] = {
	{ .supply = "vsn" },
	{ .supply = "vsp" },
};
...
static int boe_nt35596s_5p5boe_vdo_on(struct boe_nt35596s_5p5boe_vdo *ctx)
{
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x06, 0x99);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x07, 0xa3);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0e, 0xab);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0f, 0xae);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x58, 0x82);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x61, 0x02);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x44, 0x72);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x45, 0x68);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x78, 0x0f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x79, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7a, 0x2b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7b, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7c, 0x44);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7d, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7e, 0x5a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7f, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x80, 0x6f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x81, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x82, 0x81);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x83, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x84, 0x92);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x85, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x86, 0xa2);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x87, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x88, 0xd5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x89, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8a, 0xfe);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8b, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8c, 0x3c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8d, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8e, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8f, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x90, 0xb5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x91, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x92, 0xef);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x93, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x94, 0xf1);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x95, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x96, 0x29);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x97, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x98, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x99, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9a, 0x99);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9b, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9c, 0xd9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9d, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9e, 0xfc);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9f, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa0, 0x2f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa2, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa3, 0x41);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa4, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa5, 0x53);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xac, 0x90);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xad, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xae, 0xa9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xaf, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb0, 0xc7);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb1, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb2, 0xd3);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb6, 0x0f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb7, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb8, 0x2b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb9, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xba, 0x44);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xbb, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xbc, 0x5a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xbd, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xbe, 0x6f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xbf, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc0, 0x81);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc1, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc2, 0x92);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc3, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc4, 0xa2);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc5, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc6, 0xd5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc7, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc8, 0xfe);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc9, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xca, 0x3c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xcb, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xcc, 0x6c);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd0, 0xef);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd1, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd2, 0xf1);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd3, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd4, 0x29);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd5, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd6, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd7, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd8, 0x99);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd9, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xda, 0xd9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xdb, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xdc, 0xfc);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xdd, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xde, 0x2f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xdf, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe0, 0x41);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe1, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe2, 0x53);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe8, 0x90);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe9, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xea, 0xa9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xeb, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xec, 0xc7);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xed, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xee, 0xd3);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xf2, 0x0f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xf3, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xf4, 0x2b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xf5, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xf6, 0x44);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xf7, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xf8, 0x5a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xf9, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xfa, 0x6f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xff, 0x21);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xfb, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x00, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x01, 0x81);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x02, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x03, 0x92);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x04, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x05, 0xa2);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x06, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x07, 0xd5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x08, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x09, 0xfe);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0a, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0b, 0x3c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0c, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0d, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0e, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0f, 0xb5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x10, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x11, 0xef);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x12, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x13, 0xf1);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x14, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x15, 0x29);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x16, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x17, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x18, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x19, 0x99);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1a, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1b, 0xd9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1c, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1d, 0xfc);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1e, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1f, 0x2f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x20, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x21, 0x41);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x22, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x23, 0x53);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x24, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x25, 0x66);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x26, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x27, 0x7a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x28, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x29, 0x90);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2a, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2b, 0xa9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2d, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2f, 0xc7);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x30, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x31, 0xd3);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x35, 0x0f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x36, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x37, 0x2b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x38, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x39, 0x44);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3a, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3b, 0x5a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3d, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3f, 0x6f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x40, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x41, 0x81);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x42, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x43, 0x92);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x44, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x45, 0xa2);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x46, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x47, 0xd5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x48, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x49, 0xfe);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4a, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4b, 0x3c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4c, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4d, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4e, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4f, 0xb5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x50, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x51, 0xef);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x52, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x53, 0xf1);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x54, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x55, 0x29);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x56, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x58, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x59, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x5a, 0x99);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x5b, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x5c, 0xd9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x5d, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x5e, 0xfc);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x5f, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x60, 0x2f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x61, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x62, 0x41);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x63, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x64, 0x53);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x65, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x66, 0x66);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x67, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x68, 0x7a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x69, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x6a, 0x90);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x6b, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x6c, 0xa9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x6d, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x6e, 0xc7);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x6f, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x70, 0xd3);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x74, 0x0f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x75, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x76, 0x2b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x77, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x78, 0x44);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x79, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7a, 0x5a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7b, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7c, 0x6f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7d, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7e, 0x81);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7f, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x80, 0x92);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x81, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x82, 0xa2);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x83, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x84, 0xd5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x85, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x86, 0xfe);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x87, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x88, 0x3c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x89, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8a, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8b, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8c, 0xb5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8d, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8e, 0xef);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8f, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x90, 0xf1);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x94, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x95, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x96, 0x99);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x97, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x98, 0xd9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x99, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9a, 0xfc);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9b, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9c, 0x2f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9d, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9e, 0x41);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9f, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa0, 0x53);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa2, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa3, 0x66);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa4, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa5, 0x7a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa6, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa7, 0x90);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xa9, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xaa, 0xa9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xab, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xac, 0xc7);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xad, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xae, 0xd3);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xaf, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb0, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb1, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb2, 0x0f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb3, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb4, 0x2b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb5, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb6, 0x44);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb7, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb8, 0x5a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb9, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xba, 0x6f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xbb, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xbc, 0x81);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xbd, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xbe, 0x92);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xbf, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc0, 0xa2);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc1, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc2, 0xd5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc3, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc4, 0xfe);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc5, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc6, 0x3c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc7, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc8, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xc9, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xca, 0xb5);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xcb, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xcc, 0xef);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xcd, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xce, 0xf1);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd2, 0x6c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd3, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd4, 0x99);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd5, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd6, 0xd9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd7, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd8, 0xfc);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xd9, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xda, 0x2f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xdb, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xdc, 0x41);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xdd, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xde, 0x53);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xdf, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe0, 0x66);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe1, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe2, 0x7a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe3, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe4, 0x90);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe5, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe6, 0xa9);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe7, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe8, 0xc7);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe9, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xea, 0xd3);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x23, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x24, 0x0a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x25, 0x3d);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x26, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x27, 0x0a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x28, 0x38);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x29, 0x2b);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x35, 0x6d);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x36, 0x00);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3a, 0x6d);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3b, 0x23);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x74, 0x04);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x87, 0x39);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x88, 0x1b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x89, 0x39);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8a, 0xff);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8b, 0xf4);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x8c, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9b, 0xff);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x9d, 0x30);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x72, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x73, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x90, 0x72);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x91, 0x40);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x92, 0x72);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x02, 0x17);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x03, 0x0c);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0d, 0x1f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0e, 0x1e);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0f, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x10, 0x05);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x11, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x13, 0x0b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x14, 0x10);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x15, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x16, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x17, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x18, 0x42);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x19, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1a, 0x21);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1b, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1c, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1d, 0x9b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1e, 0x1d);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1f, 0x21);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2b, 0xb0);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2d, 0x3f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x2f, 0x1d);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x36, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x37, 0x0c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x38, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x39, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3a, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3b, 0x80);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3d, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3f, 0x57);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x40, 0x18);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x41, 0x06);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x42, 0x12);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x43, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x44, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x45, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x46, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x47, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x48, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4a, 0x40);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4b, 0x21);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4c, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4d, 0x17);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4e, 0x30);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x4f, 0x85);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x50, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x51, 0x1d);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x60, 0x1f);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x61, 0x3a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x62, 0x40);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x6e, 0x0c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x6f, 0x05);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x70, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x71, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x72, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x73, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x74, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x75, 0x11);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x76, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x77, 0x40);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe3, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe4, 0x20);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe5, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe6, 0x06);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe7, 0x05);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe8, 0x05);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xe9, 0x03);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xea, 0x02);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xeb, 0x05);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xec, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xed, 0x5e);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xee, 0x10);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xef, 0x82);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xf0, 0x12);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xf1, 0x70);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0a, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0b, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x04, 0x07);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x05, 0x06);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x10, 0x06);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x11, 0x07);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x13, 0x00);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x24, 0x8b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x25, 0x8b);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x26, 0x0a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x31, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x32, 0x55);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x43, 0x01);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7a, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x7b, 0x25);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x06, 0x06);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0a, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0b, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0c, 0x23);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0d, 0x46);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0e, 0x5e);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x0f, 0x7c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x10, 0x7c);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x11, 0x97);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x12, 0x46);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x13, 0x23);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1a, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1b, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x1c, 0x00);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x31, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x32, 0x0d);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x33, 0x14);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x34, 0x0d);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x39, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3a, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x3b, 0x00);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x55, 0x88);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x56, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x58, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x68, 0x00);
	...
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x87, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x88, 0x00);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x3b,
				     0x03, 0x08, 0x08, 0x0a, 0x0a);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x35, 0x00);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0xb0, 0x01);
	mipi_dsi_dcs_set_display_brightness_multi(&dsi_ctx, 0x0000);
	mipi_dsi_generic_write_seq_multi(&dsi_ctx, 0x55, 0x83);
...
static int boe_nt35596s_5p5boe_vdo_prepare(struct drm_panel *panel)
{
	...
	ret = regulator_bulk_enable(ARRAY_SIZE(boe_nt35596s_5p5boe_vdo_supplies), ctx->supplies);
	if (ret < 0) {
	...
	if (ret < 0) {
		...
		gpiod_set_value_cansleep(ctx->reset_gpio, 1);
		regulator_bulk_disable(ARRAY_SIZE(boe_nt35596s_5p5boe_vdo_supplies), ctx->supplies);
		return ret;
	}
...
{
	return drm_connector_helper_get_modes_fixed(connector, &boe_nt35596s_5p5boe_vdo_mode);
}
...
static int boe_nt35596s_5p5boe_vdo_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx = devm_drm_panel_alloc(dev, struct boe_nt35596s_5p5boe_vdo, panel,
				   &boe_nt35596s_5p5boe_vdo_panel_funcs,
				   DRM_MODE_CONNECTOR_DSI);
	if (IS_ERR(ctx))
		return PTR_ERR(ctx);

	ret = devm_regulator_bulk_get_const(dev,
					    ARRAY_SIZE(boe_nt35596s_5p5boe_vdo_supplies),
					    boe_nt35596s_5p5boe_vdo_supplies,
					    &ctx->supplies);
	if (ret < 0)
		return ret;
...
static const struct of_device_id boe_nt35596s_5p5boe_vdo_of_match[] = {
	{ .compatible = "leeco,s2-nt35596s-boe" }, // FIXME
	{ /* sentinel */ }
};
